...
class PhotoGalleryController extends PageController
{
    ...
    public static function load_requirements()
    {
        ...
        Requirements::CSS('photogallery/client/css/photogallery.css');
        Requirements::javascript('photogallery/magnific-popup/libs/jquery/jquery.js');
        Requirements::javascript('photogallery/magnific-popup/dist/jquery.magnific-popup.js');
        Requirements::javascript('photogallery/client/js/magnific-popup_init.js');
    }
