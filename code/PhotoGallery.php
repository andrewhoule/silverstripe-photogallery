...
class PhotoGallery extends Page
{
    ...
    public function getCMSFields()
    {
        ...
        $fields->addFieldsToTab('Root.AlbumSettings', array (
            ...
            NumericField::create('AlbumsPerPage'),
            NumericField::create('AlbumThumbnailWidth'),
            NumericField::create('AlbumThumbnailHeight'),
        ...
        $fields->addFieldsToTab('Root.PhotoSettings', array (
            NumericField::create('PhotosPerPage'),
            NumericField::create('PhotoThumbnailWidth'),
            NumericField::create('PhotoThumbnailHeight'),
            NumericField::create('PhotoFullWidth'),
            NumericField::create('PhotoFullHeight'),
